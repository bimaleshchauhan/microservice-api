import  CustomerRepository  from "../database/controller/Users.js";
...
class UserService {
    ...
    async DeleteAddress(customerId, updatedAddress, isRemove){
        ...
        try {
            ...
            const addressResult = await this.repository.DeleteAddress(customerId, {addressId, street, postalCode,city,country}, isRemove);
            return FormateData(addressResult);
        } catch (err) {
            throw new APIError('Data Not found', err)
        }
    ...
    async SubscribeEvents(payload){
        ...
        switch(event){
            ...
            case 'CREATE_ORDER':
                ...
                break;
            case 'REMOVE_ADDRESS':
                this.ManageAddress(userId,order, true);
                break;
            case 'Testing':
                console.log("testing")
                break;    
